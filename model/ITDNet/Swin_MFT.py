...
class MFTBlock(nn.Module):
    def __init__(self, trans_dim = 256, head_dim = 4, window_size = 4, window_size_fm = 8, drop_path = 0., type='W',hyper=False):
        """ SwinTransformer and Conv Block
        """
        super(MFTBlock, self).__init__()
...
if __name__ == '__main__':
    ...
    combined_tensor = torch.randn(2,256,16,16).cuda()
    feature_extracter=MFTBlock()
