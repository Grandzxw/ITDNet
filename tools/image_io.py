...
def process_channels(arr):
    ...
    参数：
    arr (numpy.ndarray): 输入的 64*1920*2 形状的数组
    ...
    #     raise ValueError("输入数组的形状必须是 64*1920*2 或 32*1440*2")

    # if arr.shape != (32, 1920, 2):
    #     raise ValueError("输入数组的形状必须是 64*1920*2")
...
def save_npy_nosave(image_tensor, output_path="output/"):
    image_np = torch_to_np(image_tensor)
