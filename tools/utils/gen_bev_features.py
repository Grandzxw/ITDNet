...
if __name__ == "__main__":
    ...
    for seq in seqs:
        ...
        dst_folder = os.path.join("/home/hit/sda/place_recognition/dataset_overlapnetvlad/ori_dataset", seq, "BEV_FEA")
        if not os.path.exists(dst_folder):
            os.makedirs(dst_folder, exist_ok=True)
        extract_kitti(net, scan_folder, dst_folder, batch_num)
        

# /home/hit/sda/place_recognition/OverlapNetVLAD-master/premodel/backbone.ckpt
# /home/hit/sda/place_recognition/OverlapNetVLAD-master/premodels/backbone.ckpt
